...
x = 1
abc=[]
df = pd.read_csv("../Assignment 1/Data/Generated/By Algorithms/Textrank_top100.csv",header=None,names=["0","words","rate"])
#df = pd.read_csv("Z:/ADS/a/textrank_final.csv")
with open('../Assignment 1/Data/Generated/By Algorithms/Textrank_top100.csv', newline='') as myFile:
...
df2_transposed2.to_csv("../Assignment 1/Data/Generated/By Algorithms/final_files/Textrank_final_file.csv",index=False, encoding='utf8')
